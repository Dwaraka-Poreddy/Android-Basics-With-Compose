...
fun SportsApp(
    ...
    Log.d("SportsApp", "contentType: $contentType")
...
fun SportsAppBar(
    ...
    TopAppBar(
        title = {
            if (contentType == SportsContentType.ListAndDetail) {
                Text(text = stringResource(R.string.list_fragment_label))
            } else {
                Text(
        ...
        navigationIcon = if (contentType == SportsContentType.ListAndDetail || !isShowingListPage) {
            {
